...
public class ClearCommandTest {
    ...
    void clearsUserMeals_noInputs_printsMessage() throws EZMealPlanException {
        ...
        assertEquals(2, wishList.getList().size(), "User meal list should contain 2 meals before clearing.");
        ...
        assertTrue(wishList.getList().isEmpty(), "User meal list should be empty after ClearCommand.");
