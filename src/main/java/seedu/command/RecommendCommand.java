...
public class RecommendCommand extends Command {
    ...
    public void execute(MealManager mealManager, UserInterface ui) {
        ...
        List<Meal> candidateMeals = filterMealsByIngredient(wishList.getList(), ingredientKeyword);
        ...
        if (candidateMeals.isEmpty()) {
            ...
            candidateMeals = filterMealsByIngredient(recipesList.getList(), ingredientKeyword);
        }
